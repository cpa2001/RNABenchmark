...
LOG_ROOT="./outputs/ft/rna-all/NoncodingRNAFamily/logs/plain-readout-pilot-seed-${SEED}-${TIMESTAMP}"
COMMON_ARGS=("$@")
GPU_IDS_CSV="${GPU_IDS_CSV:-0,1,2,3,4,5,6,7}"
IFS=',' read -r -a GPU_IDS <<<"${GPU_IDS_CSV}"
LRS=("5e-5" "2e-4" "1e-3")
POOLINGS=("content_mean" "cls_ln")
...
LOOP1_VARIANT="loop1-stage-d-plain-readout-pilot"
RECUR_VARIANT="stage-d-100k-plain-readout-pilot"
...
echo "=========================================="
echo "Launching EcoRNA plain readout pilot"
echo "Seed: ${SEED}"
...
echo "=========================================="
echo "EcoRNA plain readout pilot completed."
echo "Logs: ${LOG_ROOT}"
echo "=========================================="
