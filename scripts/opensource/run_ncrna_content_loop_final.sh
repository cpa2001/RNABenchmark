...
LOG_ROOT="./outputs/ft/rna-all/NoncodingRNAFamily/logs/content-loop-final-${WINNER_POOLING}-lr-${WINNER_LR}-${TIMESTAMP}"
COMMON_ARGS=("$@")
...
LOOP1_VARIANT="loop1-stage-d-content-loop-final"
RECUR_VARIANT="stage-d-100k-content-loop-final"
...
echo "=========================================="
echo "Launching EcoRNA content-loop final"
...
echo "=========================================="
echo "EcoRNA content-loop final completed."
echo "Logs: ${LOG_ROOT}"
echo "=========================================="
